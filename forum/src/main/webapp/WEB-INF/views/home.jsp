...
<input type="button" onclick="btnok();" value="주소출력"/><br/>
...
<script type="text/javascript">
function btnok() {
	var test = document.getElementById("sample5_address").value ;
	alert(test);
}
...
<script type="text/javascript">
function getAddress() {
	var getzipcode = document.getElementById("sample4_postcode").value;
	var oldaddress = document.getElementById("sample4_jibunAddress").value;
...
<input type="button" onclick="getAddress()" value="주소가져오기" /><br>
