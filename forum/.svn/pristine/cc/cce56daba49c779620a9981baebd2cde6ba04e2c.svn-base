...
<script type="text/javascript">
	...
	function check_register(){
		if((check_pw=='true')&&(check_nick=='true')){
...
<!-- 콘텐츠 시작 { -->
	<div id="wrapper">
		<div id="container">
			<div id="container_title">회원 정보 수정</div>
			<!-- 회원정보 입력/수정 시작 { -->
			<div class="mbskin">
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="text" name="user_id" value="${sessionScope.userinfo.user_id}"
											id="reg_mb_id" required class="frm_input required " readonly="readonly"
								...
								<tr>
									<th scope="row">
										<label for="reg_mb_password">이전비밀번호<strong class="sound_only">필수</strong></label>
									</th>
									<td>
										<input type="password" name="user_pw_old"
											id="reg_mb_password_old" required class="frm_input required"
											minlength="3" maxlength="20">
										<span id="msg_mb_password_old"></span>
									</td>
								</tr>
								<tr>
									<th scope="row">
									...
									<td>
										<input type="password" name="user_pw" value=""
											id="reg_mb_password" class="frm_input"
											minlength="3" maxlength="20">
								...
								<tr>
									...
									<td><input type="password" name="user_pw_check" value=""
										id="reg_mb_password_re" class="frm_input"
								...
								<tr>
									...
									<td>
									<input type="text" name="user_nick" id="reg_mb_nick"
										required class="frm_input required nospace" size="10" value="${sessionScope.userinfo.user_nick}"
										maxlength="20">
							...
							<tbody>
								<tr>
									...
									<input type="text" id="reg_mb_name" name="user_name"
										value="${sessionScope.userinfo.user_name}" required class="frm_input required " size="10">
									</td>
								</tr>
								<tr>
									...
									<td>
									<input type="text" name="user_phone" value="${sessionScope.userinfo.user_phone}" id="reg_mb_phone"
								...
								<tr>
									...
									<td>
									<input type="text" name="user_zipcode" value="${sessionScope.userinfo.user_zipcode}" id="reg_mb_zipcode" readonly="readonly"
										required class="frm_input required nospace">
								...
								<tr>
									...
									<td>
									<input type="text" name="user_address" value="${sessionScope.userinfo.user_address}" id="reg_mb_address" readonly="readonly"
								...
								<tr>
									...
									<td>
									<input type="text" name="user_email" value="${sessionScope.userinfo.user_email}" id="reg_mb_email"
